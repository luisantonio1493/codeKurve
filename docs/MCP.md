...
`codekurve_find_implementations`, `codekurve_trace_path`,
`codekurve_analyze_impact`, `codekurve_project_overview`,
`codekurve_doctor`, `codekurve_reindex` (disabled by default). Full input
schemas: plan §28.2.
