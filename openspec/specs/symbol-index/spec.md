...
`symbol_key` MUST be based on content identity (`language`, `relative_path`, `symbol_kind`, `qualified_name`, `signature_fingerprint`) and MUST NOT include `start_byte` or any other line/byte position field (§16.3).
